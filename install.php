<?php
/**
 * NSBM Marketplace AI - Installation Script
 * 
...
echo "<!DOCTYPE html><html><head><title>NSBM Marketplace AI - Installation</title>";
echo '<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">';
echo '<style>body{background:#0a0a1a;color:#e0e0e0;font-family:Inter,sans-serif;padding:2rem;} .card{background:rgba(20,20,40,0.9);border:1px solid rgba(255,255,255,0.1);border-radius:12px;} .text-success{color:#00d4aa!important;} .text-danger{color:#ff6b9d!important;} .text-warning{color:#ffc107!important;}</style>';
echo "</head><body><div class='container' style='max-width:700px;'>";
echo "<div class='card p-4'>";
echo "<h2 class='text-center mb-4' style='background:linear-gradient(135deg,#6c63ff,#00d4aa);-webkit-background-clip:text;-webkit-text-fill-color:transparent;'>NSBM Marketplace AI - Installer</h2>";
...
if ($step === 'install' && $_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Update config file
        $configContent = "<?php\n/**\n * Database Configuration - NSBM Marketplace AI\n * Auto-generated by installer\n */\n\n";
        ...
        echo "<p>NSBM Marketplace AI has been installed successfully.</p>";
